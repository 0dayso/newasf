...
CREATE TABLE IF NOT EXISTS `asf_evaluat` (
  ...
  `from_city` varchar(20) DEFAULT NULL COMMENT '出发城市',
  `to_city` varchar(20) DEFAULT NULL COMMENT '到达城市',
  `total` tinyint(1) NOT NULL DEFAULT '1' COMMENT '总体评价',
  `server` tinyint(1) NOT NULL DEFAULT '1' COMMENT '顾问服务',
  `speed` tinyint(1) NOT NULL DEFAULT '1' COMMENT '出票速度',
  `price` tinyint(1) NOT NULL DEFAULT '1' COMMENT '机票价格',
  `contents` text COMMENT '评价内容',
  `status` tinyint(1) NOT NULL DEFAULT '0',
  `audit_id` int(11) DEFAULT '0',
