	...
	$("#radio_sel input").each(function(i){
		...
		$(this).click(function(){
			...
			if(i==2){
				...
				var html="<li class='left'><span>出发城市</span> <input type='text' class='text city' name='startCity1' value='城市名' /></li><li><span>到达城市</span> <input type='text' class='text city' name='arriveCity1' value='城市名' /></li><li><span>出发日期</span> <input type='text' class='text date' name='startTIme1' value='出发时间'  /></li>";
                div.html(html);
				var lis=div.find("li");
